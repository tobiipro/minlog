"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.MinLog = exports.defaultLevels = void 0;var _lodashFirecloud = _interopRequireDefault(require("lodash-firecloud"));
...
class MinLog {
  ...
  constructor({
    ...
    levels = {} } =
  {}) {_defineProperty(this, "levels", exports.defaultLevels);_defineProperty(this, "serializers", []);_defineProperty(this, "listeners", []);
