"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.TypescriptMinLog = exports.MinLog = void 0;var _lodashFirecloud = _interopRequireDefault(require("lodash-firecloud"));
...
class MinLog {
  ...
  constructor(options = {}) {_defineProperty(this, "serializers", []);_defineProperty(this, "listeners", []);_defineProperty(this, "levels", _defaultLevels.default);_defineProperty(this, "requireRawEntry", false);_defineProperty(this, "requireSrc", false);_defineProperty(this, "time", void 0);
    ...
    _lodashFirecloud.default.forEach(this.levels, (levelCode, levelName) => {
      ...
      this[levelName] = async (...args) => {
        return await (async createError => {try {return await this.log(levelCode, ...args);} catch (_awaitTraceErr) {let err = createError();_awaitTraceErr.stack += "\n...\n" + err.stack;throw _awaitTraceErr;}})(() => new Error());
      };
    });
  }
  ...
  async log(levelCodeOrName, ...args) {
    ...
    if (this.requireSrc) {
      ...
      let babelSrcAbsoluteFilename = _lodashFirecloud.default.get(args[0], '_babelSrc.file');
    ...
    for (let serializer of this.serializers) {
      entry = await (async createError => {try {return await serializer({ entry, logger: this, rawEntry });} catch (_awaitTraceErr2) {let err = createError();_awaitTraceErr2.stack += "\n...\n" + err.stack;throw _awaitTraceErr2;}})(() => new Error());
    ...
    for (let listener of this.listeners) {
      await (async createError => {try {return await listener({ entry, logger: this, rawEntry });} catch (_awaitTraceErr3) {let err = createError();_awaitTraceErr3.stack += "\n...\n" + err.stack;throw _awaitTraceErr3;}})(() => new Error());
    }
  }
  ...
  async trackTime(...args) {
    ...
    let result = await (async createError => {try {return await fn();} catch (_awaitTraceErr4) {let err = createError();_awaitTraceErr4.stack += "\n...\n" + err.stack;throw _awaitTraceErr4;}})(() => new Error());
    args.push({
      _timeEnd: Date.now() });
...
let TypescriptMinLog = MinLog;exports.TypescriptMinLog = TypescriptMinLog;var _default = exports.TypescriptMinLog;exports.default = _default;
