...
let _isAwsLambda = exports._isNode && !_lodashFirecloud.default.isUndefined(process.env.LAMBDA_TASK_ROOT);exports._isAwsLambda = _isAwsLambda;
...
let logToConsole = function (cfg = {}) {
  ...
  return async function ({ entry, logger, rawEntry }) {
    ...
    let maybeContextFormat = _lodashFirecloud.default.isUndefined(cfg.contextId) ? '' : ' in the %s context';
