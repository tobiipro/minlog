...
exports.default = exports.logToConsole = exports._levelToConsoleFun = void 0;
...
let _levelToConsoleFun = function ({
  level,
  levels
}) {
  ...
  return (
    ...
    function () {
      var _ref = (0, _bluebird.coroutine)(function* ({
        ...
        maxLevel = _lodashFirecloud.default.floor(maxLevel / 10) * 10 + 10 - 1; // round up to next level, not inclusive
        ...
        let iframeId = _lodashFirecloud.default.defaultTo(cfg.iframeId, window.parent === window ? 'top' : '?');
        ...
        let extra = _lodashFirecloud.default.omit(rawEntry, ['_args', '_babelSrc', '_level', '_src', '_time', 'iframeId', 'msg']);

        _lodashFirecloud.default.merge(extra, context); // devTools console sorts keys when object is expanded


        extra = _lodashFirecloud.default.toPairs(extra);
        extra = _lodashFirecloud.default.sortBy(extra, 0);
        extra = _lodashFirecloud.default.fromPairs(extra); // devTools collapses objects with 'too many' keys,
...
var _default = exports.logToConsole;
