"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.logToConsole = exports.toFormatArgs = exports.serialize = exports._levelToConsoleFun = exports._isNode = exports._isBrowser = void 0;
...
exports._levelToConsoleFun = _levelToConsoleFun;let serialize = function ({ entry, logger, rawEntry: _rawEntry, cfg })
  ...
  return async function ({ entry, logger, rawEntry }) {
    ...
    _lodashFirecloud.default.forEach(extra, function (value, key) {
      ...
      if (exports._isBrowser) {
        ...
        let valueStr = (0, _fastSafeStringify.default)(valueObj, undefined, 2);
        valueStr = `\n${valueStr}`;
