...
import { MinLogLevel, MinLogLevelCode, MinLogLevelName, MinLogLevelNameToCode, MinLogListener, MinLogOptions, MinLogSerializer } from './types';
declare type MinLogDefaultLevelLogFns = {
    [TKey in keyof (typeof defaultLevels)]: (...args: any[]) => Promise<void>;
};
export declare class MinLog {
    ...
    log(levelCodeOrName: MinLogLevel, ...args: any[]): Promise<void>;
